...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-xs-3">
         ...
         <div class=buttom>
             <br type="submit">  {!! link_to_route('signup.get', 'Signup now',['button type' => 'submit'],['class' => 'btn btn-info btn-lg']) !!}</br>
             <br type="submit">  {!! link_to_route('users.welcome', 'HOME',['button type' => 'submit'],['class' => 'btn btn-info2']) !!}</br>
                </div>
                <div class="footer">
